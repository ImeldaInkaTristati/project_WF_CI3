...
<!-- Breadcrumbs-->
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Filter Data Sortir Barang</li>
  </ol>

  <!-- Menampilkan data kategori-->
  <!-- <?php echo validation_errors(); ?><br>  -->

  <?php echo form_open( 'Laporan/cetakLaporanMasuk/', array('class' => 'needs-validation', 'novalidate' => '') ); ?> 
  <div class="card mb-3">
    <div class="card-header"><i class="fa fa-sitemap"></i>Form Filter Data Sortir Barang</div>
    <div class="card-body">
