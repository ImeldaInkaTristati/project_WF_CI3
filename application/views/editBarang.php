    ...
    <div class="card-body">
      <!-- <div class="row"> -->
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="nm_brg" placeholder="Pupuk Kompos" value="<?php echo set_value('nm_brg', $barang->nm_brg) ?>" required>
		...
		<div class="form-group">
			...
			<?php echo form_dropdown('kd_supplier', $supplier, set_value('kd_supplier', $barang->kd_supplier), 'class="form-control" required' ); ?>
