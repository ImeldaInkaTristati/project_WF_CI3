...
<!-- Breadcrumbs-->
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Filter Data Keluar</li>
  </ol>

  <!-- Menampilkan data kategori-->
  <!-- <?php echo validation_errors(); ?><br>  -->

  <?php echo form_open( 'Laporan/cetakLaporanKeluar/', array('class' => 'needs-validation', 'novalidate' => '') ); ?> 
  <div class="card mb-3">
    <div class="card-header"><i class="fa fa-sitemap"></i>Form Filter Data Barang Keluar</div>
    <div class="card-body">
