  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <!-- <div class="row"> -->
		...
		<h4 align="center">Edit Data Work Order</h4><br>
		...
		<div class="form-group">
			...
			<?php echo form_dropdown('kd_pembeli', $pembeli, set_value('kd_pembeli', $order->kd_pembeli), 'class="form-control" required' ); ?>
			<div class="invalid-feedback">Mohon isikan Nama Pembeli</div>
		</div>
		<div class="form-group">
			<label for="">Nama Barang</label>
			<?php echo form_dropdown('kd_brg', $barang, set_value('kd_brg', $order->kd_brg), 'class="form-control" required' ); ?>
			<div class="invalid-feedback">Mohon isikan Nama Barang</div>
		</div>
		<div class="form-group">
			<label for="">Jumlah Pesanan Barang dalam KG</label>
			<input type="text" class="form-control" name="jumlahOrder" placeholder="5000" value="<?php echo set_value('jumlahOrder', $order->jumlahOrder) ?>" required>
		...
		<div class="form-group">
			...
			<input type="date" class="form-control" name="tgl_pesan" value="<?php echo set_value('tgl_pesan', $order->tgl_pesan) ?>" required>
			<!-- <input type="text" class="form-control" name="nm_pembeli" placeholder="" required> -->
			<div class="invalid-feedback">Mohon isikan Tanggal Pemesanan</div>
		</div>
		<div class="form-group">
			<label for="">Tanggal Kirim</label>
			<input type="date" class="form-control" name="tgl_kirim" value="<?php echo set_value('tgl_kirim', $order->tgl_kirim) ?>" required>
			<!-- <input type="text" class="form-control" name="nm_pembeli" placeholder="" required> -->
